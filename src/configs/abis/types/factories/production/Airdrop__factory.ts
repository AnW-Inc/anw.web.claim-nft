...
import type { Airdrop, AirdropInterface } from '../../production/Airdrop'
    ...
    outputs: [
      {
        ...
        internalType: 'struct Airdrop.InfoAirdrop[]',
        name: '',
        type: 'tuple[]',
      },
    ],
